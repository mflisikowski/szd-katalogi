...
import { hookResolveCategories } from './media-categories-hook'
...
export const Media: CollectionConfig = {
  ...
  fields: [
    ...
    {
      // Auto-resolved from the [cat1, cat2] filename suffix (see media-categories-hook)
      admin: {
  ...
  hooks: {
    ...
    beforeValidate: [hookDeriveMediaMetadata, hookResolveCategories, hookEnsureUniqueTitleInCatalog],
  },
