...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "catalog-pages".
 */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "catalog-pages_select".
 */
export interface CatalogPagesSelect<T extends boolean = true> {
  tenant?: T;
  media?: T;
  pageNumber?: T;
  prefix?: T;
